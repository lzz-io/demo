 ...
 */
@Component
public class Step3WorkerItemReadListener implements ItemReadListener<User> {

	private static final Logger log = LoggerFactory.getLogger(Step3WorkerItemReadListener.class);
