 ...
 */
@Component
public class Step2MasterItemReadListener implements ItemReadListener<User> {

	private static final Logger log = LoggerFactory.getLogger(Step2MasterItemReadListener.class);
